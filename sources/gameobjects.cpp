							...
							if (object[i].state2<37) {
								...
								if (!item[object[i].state2-1]) {
									...
									if (object[i].state>=32) {
										/* Los objetos arma son m�s peque�os: */ 
				...
				case 1:/* Murcielago moviendose: */ 
					...
					if ((object[i].state2>=16 && object[i].state3!=-1) ||
						...
						if (iswall(t_x,t_y-1) && iswall(t_x+1,t_y-1) &&
							...
							/* Si el n�mero aleatorio es mayor que 7, se sigue en la	*/ 
							/* misma direcci�n.											*/ 
							j=object[i].state3;
...
//						object[i].x-=object[i].state;
			...
			case T_CLOUD:
				...
				if ((object[i].state2>=16 && object[i].state3!=-1) ||
					...
					/* Si el n�mero aleatorio es mayor que 11, se sigue en la	*/ 
					/* misma direcci�n.											*/ 
					j=object[i].state3;
			...
			case T_CYCLOPS:
				...
				if (object[i].state2>=32 ||
					...
					if (object[i].state3!=-1 && (rand()%80)<=20) {
						...
						/* Si el n�mero aleatorio es mayor que 7, va en	*/ 
						/* la direcci�n del personaje.					*/ 
