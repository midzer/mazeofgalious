...
void GameInGameCycle(int dx,int dy)
{
	...
	/* Determinar si se est� en posici�n de subir escalera: */ 
	...
	/* Determinar si se ha chocado con alg�n enemigo: */ 
...
//					HP_restore(map_x,map_y);
	...
	/* Corregir la posici�n del personaje: */ 
